...
const FilteredTeachersByAvailability = ({ isAvailabilityVisible, openAvailabilityFilter, timeAvailabile, removeTimeAvailability, daysAvailabile, removeDaysAvailability }: IFilteredTeachersByAvailability) => {
    return (
        <div>
